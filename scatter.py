...
def plot_data(ax, x, y, xlabel, ylabel, label):
    ...
    ax.text(0.75, 0.95, f'Pearson r: {correlation:.2f}', transform=ax.transAxes, fontsize=12, verticalalignment='top')
...
fig.legend(handles, labels, loc='lower center', ncol=2, bbox_to_anchor=(0.5, 0.03), fontsize=12)

# Adjust layout to reduce white space
plt.subplots_adjust(left=0.05, right=0.98, top=0.92, bottom=0.15, hspace=0.3, wspace=0.2)
